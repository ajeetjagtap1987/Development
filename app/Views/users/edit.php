						...
						<div class="card-body">
							<form action="<?= base_url(); ?>/users/user-update/<?= $u_id ?>" id="update" method="post" autocomplete="off">
								...
								<div class="form-group mb-3 ">
									...
									<div>
										<input type="text" name="first_name" class="form-control" placeholder="Enter First Name" value="<?= $user[0]['first_name'] ?>"><!-- 
								...
								<div class="form-group mb-3 ">
									...
									<div>
										<input type="text" name="last_name" class="form-control" placeholder="Enter Last Name" value="<?= $user[0]['last_name'] ?>">
									</div>
								</div>
								<div class="form-group mb-3 ">
								...
								<div class="form-group mb-3 ">
									...
									<div>
										<input type="text" name="job_title" class="form-control" placeholder="Enter Job Title" value="<?= $user[0]['job_title'] ?>">
									</div>
								</div>
								<div class="form-group mb-3 ">
									<label class="form-label required">Reporting Head</label>
									<div>
										<input type="text" name="reporting_head" class="form-control" value="<?= $user[0]['reporting_head'] ?>" placeholder="Enter Reporting Head name">
									</div>
								</div>
								<div class="form-group mb-3 ">
								...
								<div class="form-group mb-3 ">
									...
									<div class="input-icon mb-2">
										<input class="form-control datepicker" name="joining_date" id="joining_date" placeholder="Select Joining Date" value="<?= $user[0]['joining_date'] ?>">
										...
										<div>
											<select class="form-select" name="user_type">
												...
												foreach (USER_TYPE as $key => $value) {
													$selected = $user[0]['user_type'] == $key ? 'selected' : '';
													if ($key != ADMIN) {
										...
										<select class="form-select " name="department">
											...
											if (count($department) > 0) {
												foreach ($department as $d) {
													$select = $user[0]['department'] == $d['id'] ? 'selected' : '';
								...
								<div class="form-group mb-3 ">
									...
									<div>
										<select class="form-select microsoft_365_business_licence" name="microsoft_365_business_licence">
											<option value="">Select</option>
											<option value="Microsoft 365 Business Standard" <?= $user[0]['microsoft_365_business_licence'] == 'Microsoft 365 Business Standard' ? 'selected' : '' ?>>Microsoft 365 Business Standard</option>
											<option value="Microsoft 365 Business Basic" <?= $user[0]['microsoft_365_business_licence'] == 'Microsoft 365 Business Basic' ? 'selected' : '' ?>>Microsoft 365 Business Basic</option>
										</select>
									</div>
								</div>
								<div class="form-group mb-3 microsoft_365_apps_for_business_div" style="display: none;">
									...
									<div>
										<div class="row g-2">
											<div class="col-12">
												<?php
												if (isset($user[0]['microsoft_365_apps_for_business']) && $user[0]['microsoft_365_apps_for_business'] != '') {
													$microsoft_array = explode('@', $user[0]['microsoft_365_apps_for_business']);
												} else {
													$microsoft_array = [];
												}
												?>
												<div class="input-group mb-2">
													<input type="text" name="microsoft_365_apps_for_business_username" class="form-control microsoft_365_apps_for_business_input" value="<?php echo isset($microsoft_array) && !empty($microsoft_array) ? $microsoft_array[0] : '' ?>" placeholder="Username">
													...
													<select name="microsoft_365_apps_for_business_domainname" class="form-select microsoft_365_apps_for_business_input">
														...
														<option value="digitalzone.com" <?= !empty($microsoft_array) && $microsoft_array[1] == 'digitalzone.com' ? 'selected' : '' ?>>digitalzone.com</option>
														<option value="digitalzonein.com" <?= !empty($microsoft_array) && $microsoft_array[1] == 'digitalzonein.com' ? 'selected' : '' ?>>digitalzonein.com</option>
													</select>
												</div>
											</div>
										</div>
								...
								<div class="form-group mb-3 ">
									...
									<div>
										<select class="form-select" name="status">
											<option value="">Select</option>
											<option value="<?php echo ACTIVE ?>" <?= $user[0]['status'] == ACTIVE ? 'selected' : '' ?>>Active</option>
											<option value="<?php echo RESIGNED ?>" <?= $user[0]['status'] == RESIGNED ? 'selected' : '' ?>>RESIGNED</option>
										</select>
									</div>
								</div>
