  ...
  <div class="page-header d-print-none">
    ...
    <?php echo @view('includes/breadcrumb2', ['level_1' => 'Manufacturer List', 'level_1_url' => 'manufacturer/list', 'level_2' => 'Manufacturer Create']); ?>
  	</div>
  </div>
  <div class="page-body">
    <div class="container-xl">
        <div class="row row-cards">
          	<div class="col-12">
            	...
            	<div class="card">
                <div class="card-body">
                	<form action="<?php echo base_url();?>/manufacturer/insert" method="post" id="insert" autocomplete="off">
                  <?= csrf_field();  ?>
