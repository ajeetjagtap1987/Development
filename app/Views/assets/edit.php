	...
	<div class="container-xl">
		<div class="row row-cards">
			<div class="col-12">
				...
				<div class="card">
					<div class="card-body">
						<form action="<?= base_url(); ?>/assets/update/<?= $e_id ?>" id="update" method="post" autocomplete="off" class="inputbox">
							<?= csrf_field();  ?>
							<div class="row">
								...
								if (!empty($assets[0]['manufacturer_id'])) {
								...
								if (!empty($assets[0]['invoice_no_id'])) {
								...
								if (!empty($assets[0]['asset_location_id'])) {
								...
								if (!empty($assets[0]['price'])) {

								?>
									<div class="form-group col-md-6 mb-3">
										<label class="form-label required">Price with GST</label>
										<div>
											<input type="text" name="price" class="form-control number" value="<?= $assets[0]['price'] ?>" placeholder="Enter Price with GST">
										</div>
									</div>
								<?php
								}
								...
								if (!empty($assets[0]['purchase_date'])) {

								?>
									<div class="form-group col-md-6 mb-3">
										<label class="form-label required">Purchase Date</label>
										<div class="input-icon mb-2">
											<input class="form-control datepicker" id="purchase_date" name="purchase_date" value="<?= $assets[0]['purchase_date'] ?>" placeholder="Select Purchase Date">
								...
								if (!empty($assets[0]['warranty_expiry_date'])) {

								?>
									<div class="form-group col-md-6 mb-3">
										<label class="form-label required">Warranty Expiry Date</label>
										<div class="input-icon mb-2">
											<input class="form-control datepicker" id="warranty_expiry_date" name="warranty_expiry_date" placeholder="Select Warranty Expiry Date" value="<?= $assets[0]['warranty_expiry_date'] ?>" required>
											<span class="input-icon-addon">
												<i class="ti ti-calendar"></i>
											</span>
										</div>
								...
								if (!empty($assets[0]['installed_ram'])) {
									...
									<div class="form-group col-md-3 mb-3 desk_div lap_div server_div es_div hide_div">
										...
										<div>
											...
											<select name="ram_unit" class="form-select " required>
												...
												<option value="MB" <?php echo $assets[0]['ram_unit'] == 'MB' ? 'selected' : '' ?>>MB</option>
												<option value="GB" <?php echo $assets[0]['ram_unit'] == 'GB' ? 'selected' : '' ?>>GB</option>
												<option value="TB" <?php echo $assets[0]['ram_unit'] == 'TB' ? 'selected' : '' ?>>TB</option>
											</select>
								...
								<div class="form-group col-md-4  desk_div lap_div server_div es_div hide_div">
									...
									<div class="row ">
										...
										if (!empty($assets[0]['storage_capacity'])) {

										?>
											<div class="col-6">
												<label class="form-label required">Storage Capacity </label>
												<input type="text" name="storage_capacity" class="form-control number " value="<?= $assets[0]['storage_capacity'] ?>" placeholder="Enter Storage Capacity" required>
											</div>
										<?php
										...
										if (!empty($assets[0]['storage_capacity_unit'])) {

										?>

											<div class="col-6  desk_div lap_div server_div es_div hide_div">
												<label class="form-label required">Storage Capacity Unit</label>
												<select name="storage_capacity_unit" class="form-select" required>
													<option value="">Select</option>
								...
								if (!empty($assets[0]['windows_edition'])) {

								?>
									<div class="form-group col-md-6 mb-3 ">
										<label class="form-label required">Windows Edition</label>
										<div>
											<input type="text" name="windows_edition" class="form-control " placeholder="Enter Windows Edition" value="<?= $assets[0]['windows_edition'] ?>" required>
										</div>
									</div>
								...
								?>
									...
									<div class="form-group col-md-6 mb-3 desk_div lap_div hide_div">
										...
										<div>
											<input type="text" name="windows_key" class="form-control " placeholder="Enter Windows Key" value="<?= $assets[0]['windows_key'] ?>" required>
										</div>
									</div>
								...
								if (!empty($assets[0]['host_name'])) {

								?>
									<div class="form-group col-md-6 mb-3 desk_div hide_div">
										<label class="form-label required">Host Name</label>
										<div>
											<input type="text" name="host_name" class="form-control " placeholder="Enter Host Name" value="<?= $assets[0]['host_name'] ?>" required>
										</div>
									</div>
								...
								if (!empty($assets[0]['device_id'])) { ?>
									<div class="form-group col-md-6 mb-3 desk_div lap_div hide_div">
										<label class="form-label ">Device ID</label>
										<div>
											<input type="text" name="device_id" class="form-control " placeholder="Enter Device ID" value="<?= $assets[0]['device_id'] ?>">
										</div>
									</div>
								<?php
								}
								...
								<?php if (!empty($assets[0]['product_id'])) { ?>
									<div class="form-group col-md-6 mb-3 desk_div lap_div hide_div">
										<label class="form-label ">Product ID</label>
										<div>
											<input type="text" name="product_id" class="form-control " placeholder="Enter Product ID" value="<?= $assets[0]['product_id'] ?>">
										</div>
									</div>
								<?php
								}
								...
								<?php if (!empty($assets[0]['screen_size'])) { ?>
									<div class="form-group col-md-6 mb-3 lap_div monitor_div tv_div hide_div">
										<label class="form-label required">Screen Size</label>
										<div>
											<input type="text" name="screen_size" class="form-control " placeholder="Enter Screen Size" value="<?= $assets[0]['screen_size'] ?>" required>
										</div>
									</div>
								<?php
								}
								...
								if (!empty($assets[0]['adp_warranty'])) {

								?>
									<div class="form-group col-md-6 mb-3 lap_div hide_div">
										<label class="form-label required">ADP Warranty</label>
										<div>
											<input type="text" name="adp_warranty" class="form-control lap_input" placeholder="Enter ADP Warranty" value="<?= $assets[0]['adp_warranty'] ?>" required>
										</div>
									</div>
								<?php
								}
