...
<div class="modal modal-blur fade" id="delete_application_model" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
       ...
       <form action="<?php echo base_url(); ?>/application/delete" method="post" id="application_delete_form" autocomplete="off">
       <?= csrf_field();  ?>
         <div class="modal-body">
           <div class="form-group col-md-12 mb-3 ">
             <input type="hidden" name="applicatioin_id" id="delete_application_id" class="form-control" required>
...
function deleteApplication(id) {
     $('#delete_application_id').val('');
     if (id) {

       $('#delete_application_id').val(id);
       $('#delete_application_model').modal('show');
     }
   }

   $("#application_delete_form").submit(function(event) {
       ...
       success: function(token) {
         ...
         $.ajax({
           ...
           if (response.status == 'success') {
             ...
             $('#delete_application_model').modal('hide');
           }
  ...
  function filter_data(page) {
    ...
    $.ajax({
      ...
      success: function(token) {
        ...
        $.ajax({
          url: "<?php echo base_url() ?>/application/filter/" + page,
          method: "POST",
          data: {
