        ...
        <div class="row g-2 align-items-center">
          ...
          <div class="col-12 col-md-auto ms-auto d-print-none">
            <div class="d-flex">
              ...
              <a href="<?php echo base_url()?>/office_location/create" class="btn btn-primary">
...
<script type="text/javascript">
     ...
     function filter_data(page)
    {
      ...
      success: function(token) {
        ...
        $.ajax({
            url:"<?php echo base_url() ?>/office_location/filter/"+page,
            method:"POST",
            data:{show_per_page:show_per_page,sort_by:sort_by, order_by:order_by, show:show, keyword:keyword, created_date:created_date,csrf_test_name:token},
